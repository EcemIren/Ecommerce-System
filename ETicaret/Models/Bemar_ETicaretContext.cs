...
{
    public partial class Bemar_ETicaretContext : DbContext
    {
        static Bemar_ETicaretContext()
        {
            Database.SetInitializer<Bemar_ETicaretContext>(null);
        }

        public Bemar_ETicaretContext()
            : base("Name=Bemar_ETicaretContext")
        {
        }
